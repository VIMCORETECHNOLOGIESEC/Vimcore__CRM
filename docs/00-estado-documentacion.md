...
| `docs/20-integracion-linkedin-backend.md` | Borrador TO-BE | Diseño técnico candidato para LinkedIn Lead Sync | Detalla cambios backend por capa para OAuth, múltiples fuentes, webhook y reconciliación. No describe el AS-IS ni autoriza implementación fuera de una SDD change aprobada. |
