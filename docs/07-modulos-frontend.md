...
>
> El canal SSE es bearer-only, con cursor (`Last-Event-ID`), reintentos
> acotados (1/2/4/8/16 s) y resincronización de las caches de leads de
...
- [x] Aviso emergente al llegar una notificación por SSE
- [x] Indicador de reconexión cuando el canal SSE se interrumpe
