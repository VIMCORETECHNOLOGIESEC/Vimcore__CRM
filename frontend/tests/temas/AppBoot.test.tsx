...
describe("AppBoot", () => {
  ...
  /**
   * Fix "boot desincronizado": con una marca cacheada de una sesión previa
   * en este navegador, la cortina debe pintar ESE branding desde el primer
   * render -- no el default público del holding -- mientras `GET
   * /marca-publica` resuelve en paralelo (ya no hay refresh token que
   * indique "hubo sesión": la sesión vive en la cookie del gateway).
   */
  describe("cache optimista de marca conocida", () => {
    it("con marca cacheada, pinta la marca cacheada desde el primer render", () => {
    ...
    it("sin marca cacheada, pinta el default público", () => {
