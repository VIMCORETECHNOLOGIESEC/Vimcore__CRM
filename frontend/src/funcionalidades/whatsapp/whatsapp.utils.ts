/**
 * Utilidades del flujo de conexión de WhatsApp Business (Embedded Signup de
 * Meta, ver `docs/contrato-frontend-whatsapp-api_mat_04.md`, secciones 1-3).
 *
 ...
 */
const EMPRESA_FLUJO_STORAGE_KEY = "crm.whatsapp.empresaIdFlujo";

/**
 * Persiste el `empresaId` elegido en el Paso 1 antes de redirigir a Meta
 * (solo aplica a un actor holding-wide -- ver
 * `whatsapp.api.ts::iniciarConexionWhatsAppApi`). Con `undefined` (actor de
 ...
 * `authorizationUrl` de Meta en la misma pestaña. Envuelto en su propia
