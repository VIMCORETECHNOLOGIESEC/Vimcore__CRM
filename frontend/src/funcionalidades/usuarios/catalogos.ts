...
/**
 * Etiquetas en español de cada rol (docs/07 F7, mismo texto que
 * `PerfilPage.tsx`). `SUPERVISOR_HOLDING`/`SUPER_ADMIN` (Bloque F, tab
 * "solo holding-wide", Item 25): usuarios sin ninguna `Membresia` -- ver el
 * docblock de `RolUsuario` en `@/tipos/usuario`.
 */
